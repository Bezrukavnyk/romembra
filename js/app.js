...
if (iconMenu != null) {
	...
	iconMenu.addEventListener("click", function (e) {
		if (unlock) {
			...
			document.querySelector(".header__tell").classList.toggle("_active");
...
let moreBottom = document.querySelector('.more__wraper--bottom');
let moreBtn = document.querySelector('.more_btn');
let moreSpan = moreBtn.querySelectorAll('span');
...
moreBtn.addEventListener('click', (event)=>{
    ...
    moreBottom.classList.toggle('_active');
})

let moreTable = document.querySelector('._mobile--more');
 moreTable.addEventListener('click', ()=>{
     document.querySelector('.calc--wraper').classList.toggle('_active')
 })
...
document.querySelector('.footer__arrow').addEventListener('click', ()=>{
    up();
})

if(window.innerWidth < 1100){

   document.querySelector('._doc-main').classList.add('swiper-container');
    document.querySelector('.doc_wrap').classList.add('swiper-wrapper');
    document.querySelectorAll('.doc_block').forEach((e)=>{
        e.classList.add('swiper-slide')
    })
   let myImageSlider = new Swiper('._doc-main', {
    slidesPerView: 'auto',
 })
}
...
document.querySelector('.main__btn').addEventListener('click', ()=>{
    document.querySelector('.popup_massagename-message').classList.add('_active')
})
...
for (let anchor of anchors) {
    anchor.addEventListener('click', function (e) {
        ...
        document.querySelector('.scroll-block').classList.remove('_lock')
        document.querySelector(".header__tell").classList.remove("_active");
        document.querySelector(".header__logo").classList.remove("_active");

    })
}
 document.querySelectorAll('._phone').forEach((inp)=>{
    // Проверяем фокус
...
let politicItem = document.querySelectorAll('.politica__footer');

politicItem.forEach((e)=>{
    e.addEventListener('click', ()=>{
        document.querySelector('.popup_popup').classList.add('_active')
    })
})
document.querySelector('.btn-cookie').addEventListener('click', ()=>{
    document.querySelector('.cookie').classList.remove('_active')
})
